...
public class bellande_battery_temperature_activity {
    private let batteryTemperatureService: bellande_battery_temperature_service
    ...
    public init() {
        ...
        let batteryTemperatureAPI = bellande_battery_temperature_api(baseURL: apiUrl)
        self.batteryTemperatureService = bellande_battery_temperature_service(
            apiURL: apiUrl,
            inputEndpoint: inputEndpoint,
            outputEndpoint: outputEndpoint,
            apiAccessKey: apiAccessKey,
            batteryTemperatureAPI: batteryTemperatureAPI
        )
    }
