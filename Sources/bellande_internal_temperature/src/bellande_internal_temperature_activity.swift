...
public class bellande_internal_temperature_activity {
    private let internalTemperatureService: bellande_internal_temperature_service
    ...
    public init() {
        ...
        let internalTemperatureAPI = bellande_internal_temperature_api(baseURL: apiUrl)
        self.internalTemperatureService = bellande_internal_temperature_service(
            apiURL: apiUrl,
            inputEndpoint: inputEndpoint,
            outputEndpoint: outputEndpoint,
            apiAccessKey: apiAccessKey,
            internalTemperatureAPI: internalTemperatureAPI
        )
    }
