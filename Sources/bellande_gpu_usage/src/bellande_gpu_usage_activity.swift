...
public class bellande_gpu_usage_activity {
    private let gpuUsageService: bellande_gpu_usage_service
    ...
    public init() {
        ...
        let gpuUsageAPI = bellande_gpu_usage_api(baseURL: apiUrl)
        self.gpuUsageService = bellande_gpu_usage_service(
            apiURL: apiUrl,
            inputEndpoint: inputEndpoint,
            outputEndpoint: outputEndpoint,
            apiAccessKey: apiAccessKey,
            gpuUsageAPI: gpuUsageAPI
        )
    }
