...
public class bellande_storage_usage_activity {
    private let storageUsageService: bellande_storage_usage_service
    ...
    public init() {
        ...
        let storageUsageAPI = bellande_storage_usage_api(baseURL: apiUrl)
        self.storageUsageService = bellande_storage_usage_service(
            apiURL: apiUrl,
            inputEndpoint: inputEndpoint,
            outputEndpoint: outputEndpoint,
            apiAccessKey: apiAccessKey,
            storageUsageAPI: storageUsageAPI
        )
    }
