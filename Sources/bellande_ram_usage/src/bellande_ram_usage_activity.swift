...
public class bellande_ram_usage_activity {
    private let ramUsageService: bellande_ram_usage_service
    ...
    public init() {
        ...
        let ramUsageAPI = bellande_ram_usage_api(baseURL: apiUrl)
        self.ramUsageService = bellande_ram_usage_service(
            apiURL: apiUrl,
            inputEndpoint: inputEndpoint,
            outputEndpoint: outputEndpoint,
            apiAccessKey: apiAccessKey,
            ramUsageAPI: ramUsageAPI
        )
    }
