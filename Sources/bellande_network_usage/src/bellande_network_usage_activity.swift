...
public class bellande_network_usage_activity {
    private let networkUsageService: bellande_network_usage_service
    ...
    public init() {
        ...
        let networkUsageAPI = bellande_network_usage_api(baseURL: apiUrl)
        self.networkUsageService = bellande_network_usage_service(
            apiURL: apiUrl,
            inputEndpoint: inputEndpoint,
            outputEndpoint: outputEndpoint,
            apiAccessKey: apiAccessKey,
            networkUsageAPI: networkUsageAPI
        )
    }
