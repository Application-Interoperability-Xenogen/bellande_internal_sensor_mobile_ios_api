...
public class bellande_gpu_temperature_activity {
    private let gpuTemperatureService: bellande_gpu_temperature_service
    ...
    public init() {
        ...
        let gpuTemperatureAPI = bellande_gpu_temperature_api(baseURL: apiUrl)
        self.gpuTemperatureService = bellande_gpu_temperature_service(
            apiURL: apiUrl,
            inputEndpoint: inputEndpoint,
            outputEndpoint: outputEndpoint,
            apiAccessKey: apiAccessKey,
            gpuTemperatureAPI: gpuTemperatureAPI
        )
    }
